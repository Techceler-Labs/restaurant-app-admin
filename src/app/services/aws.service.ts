...
export class AwsService {
 ...
 /************ RESOURCE IDENTIFIERS *************/
  ...
  poolData = { 
        UserPoolId : 'us-east-1_Tamsmqfbk', //CognitoUserPool
        ClientId : '76el96585015scev21vep6j9nq', //CognitoUserPoolClient 
        Paranoia : 7
    };
  identityPool:string = 'XXXXXXXXXXXXXXXXXXXXXXXXXXX'; //CognitoIdentityPool 
  apiURL:string = 'https://cognito-idp.us-east-1.amazonaws.com/us-east-1_Tamsmqfbk';  //ApiUrl
